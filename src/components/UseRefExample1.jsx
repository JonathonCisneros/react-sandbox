...
function UseRefExample1 ( ) {
  ...
  return (
    <div>
      ...
      <h3 className='text-secondary'>Use <i>useRef()</i> to change elements. Try hitting the submit button. Click the text <i>Hello from paragraph!</i> </h3>
      ...
      <p
        onClick={ ( ) => {
          ...
          paraRef.current.innerText = 'Input is now focused and my text has changed.';
        }}
        ref={ paraRef }
      >
